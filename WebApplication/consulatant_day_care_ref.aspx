<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site2.Master" CodeBehind="consulatant_day_care_ref.aspx.vb" Inherits="WebApplication1.consulatant_day_care_ref" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Consultant Day Care Reference</title>
    <style>
        .dropdown-item:hover{
            color:white;
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     <h3 class="text-white mt-2 font-weight-bold">Consultant Day Care Reference</h3>
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <div class="container-fluid pt-1 pl-0 pr-0">
        <fieldset class="border border-dark w-100 p-1 rounded m-1">
            <legend class="w-auto mb-0 t2-size font-weight-bold">Consultant Reference Details</legend>
            <div class="row">
               <div class="col-sm-12 col-lg-8 col-xs-12">
                   
                   <div class="row">
                   <div class="col-lg-6 col-md-6 col-sm-12 d-flex p-2">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 d-flex p-2">
                        <div class="col-4 pr-0"><label for="" class="btn-block h-90 bg-primary border border-dark pt-1 word2 font-weight-bold text-center">Consultation</label></div>
                   ...
                   <div class="row">
                   <div class="col-lg-6 col-md-6 col-sm-12 d-flex p-2">
                        <div class="col-4 pr-0"><label for="" class="btn-block h-90 bg-primary border border-dark pt-1 word2 font-weight-bold text-center">Consultant</label></div>
                   ...
                   <div class="col-lg-6 col-md-6 col-sm-12 d-flex p-2">
                       <div class="col-4 pr-0"> <label for="" class="btn-block h-90 bg-primary border border-dark pt-1 word2 font-weight-bold text-center">Phone</label></div> 
                       <div class="col-8"><asp:TextBox ID="TextBox3" runat="server" CssClass="form-control h-90" TextMode="Phone"></asp:TextBox></div>
                   </div>
                       </div>
                       <div class="row">
                   <div class="col-lg-6 col-md-6 col-sm-12 d-flex p-2">
                       <div class="col-4 pr-0"> <label for="" class="btn-block h-65 bg-primary  border border-dark pt-1 word2 font-weight-bold text-center">Provisional Diagnosis</label></div> 
                       <div class="col-8"><asp:TextBox ID="TextBox4" runat="server" CssClass="form-control h-100" TextMode="MultiLine"></asp:TextBox></div>
                   </div>
                   <div class="col-lg-6 col-md-6 col-sm-12 d-flex p-2">
                       <div class="col-4 pr-0"> <label for="" class="btn-block h-65 bg-primary  border border-dark pt-1 word2 font-weight-bold text-center">Address</label></div> 
                       <div class="col-8"><asp:TextBox ID="TextBox5" runat="server" CssClass="form-control h-100" TextMode="MultiLine"></asp:TextBox></div>
                   </div>
                            </div>
                           <div class="row">
                   <div class="col-lg-6 col-md-6 col-sm-12 d-flex p-2">
                       <div class="col-4 pr-0"> <label for="" class="btn-block h-65 bg-primary  border border-dark pt-1 word2 font-weight-bold text-center">Clinical Notes</label></div> 
                    <div class="col-8"><asp:TextBox ID="TextBox6" runat="server" CssClass="form-control h-100" TextMode="MultiLine"></asp:TextBox></div>
                   </div>
                   <div class="col-lg-6 col-md-6 col-sm-12 d-flex p-2">
                       <div class="col-4 pr-0"> <label for="" class="btn-block h-65 bg-primary border border-dark pt-1 word2 font-weight-bold text-center">Procedures</label></div> 
                    <div class="col-8"><asp:TextBox ID="TextBox7" runat="server" CssClass="form-control h-100" TextMode="MultiLine"></asp:TextBox></div>
                   </div>
               </div>
                
                </div>
                <div class="col-sm-12 col-lg-4 col-xs-12 pr-4 pl-4 pt-0">
                     <fieldset class="border border-dark w-100 pb-0 pt-0 pr-2 pl-2 rounded">
                    <legend class="w-auto mb-0 t1-size font-weight-bold">Procedures</legend>
                    <div clas="row">
                        <div class="col-12 p-2">
                            <asp:DropDownList ID="DropDownList4" runat="server" CssClass="form-control h-90">
                       <asp:ListItem>1</asp:ListItem>
                      </asp:DropDownList>
                        </div>
                    </div>
                    <div clas="row">
                        <div class="col-12 p-2">
                            <asp:DropDownList ID="DropDownList5" runat="server" CssClass="form-control h-90">
                       <asp:ListItem>1</asp:ListItem>
                      </asp:DropDownList>
                        </div>
                    </div>
                    <div clas="row">
                        <div class="col-12 p-2">
                            <asp:DropDownList ID="DropDownList6" runat="server" CssClass="form-control h-90">
                       <asp:ListItem>1</asp:ListItem>
                      </asp:DropDownList>
                        </div>
                    </div>
    ...
    <div class="container-fluid pr-0 pl-0 pt-0">
         <fieldset class="border border-dark rounded w-100 pt-1 pr-3 pl-3 pb-3">
                    <legend class="w-auto mb-0 t2-size font-weight-bold">Previous Reference Details</legend>
