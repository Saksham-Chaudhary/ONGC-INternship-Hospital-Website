<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site2.Master" CodeBehind="indoor.aspx.vb" Inherits="WebApplication1.indoor" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <h3 class="text-white mt-2 font-weight-bold">Indoor Reference</h3>
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <div class="container-fluid pr-0 pl-0 pt-0">
         <fieldset class="border border-dark rounded w-100 pt-1 pr-3 pl-3 pb-3">
                    <legend class="w-auto mb-0 t2-size font-weight-bold">Previous Indoor Reference Details</legend>
