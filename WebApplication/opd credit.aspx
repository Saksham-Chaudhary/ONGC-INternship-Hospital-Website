<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site2.Master" CodeBehind="opd credit.aspx.vb" Inherits="WebApplication1.opd_credit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Indoor Reference</title>
    <style>
        .dropdown-item:hover{
            color:white;
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <h3 class="text-white mt-2 font-weight-bold">OPD Credit Reference</h3>
</asp:Content>
        ...
        <fieldset class="border border-dark w-100 p-1 rounded m-1">
            ...
            <div class="row">
               <div class="col-sm-12 col-lg-4 col-xs-12 d-flex p-2">
                 ...
                 <div class="col-sm-12 col-lg-4 col-xs-12 d-flex p-2">
                     <div class="col-4 pr-0"><label for="" class="btn-block h-90 bg-primary border border-dark pt-1 word2 font-weight-bold text-center">Admission Date</label></div>
                     <div class="col-8"> <asp:TextBox ID="TextBox3" runat="server" cssClass="form-control h-90 pb-0" TextMode="Date"></asp:TextBox>
                     </div>
                    
                 </div>
                <div class="col-sm-12 col-lg-4 col-xs-12 d-flex p-2">
                <div class="col-4 pr-0"> <label for="" class="btn-block h-90 bg-primary border border-dark pt-1 word2 font-weight-bold text-center">Billing</label></div> 
                <div class="col-8"><asp:TextBox ID="TextBox4" runat="server" CssClass="form-control h-90"></asp:TextBox></div>
            </div>
                <div class="col-sm-12 col-lg-4 col-xs-12 d-flex p-2">
                <div class="col-4 pr-0"> <label for="" class="btn-block h-90 bg-primary border border-dark pt-1 word3 font-weight-bold text-center">Grade Of Accomodation</label></div> 
                <div class="col-8"><asp:TextBox ID="TextBox5" runat="server" CssClass="form-control h-90"></asp:TextBox></div>
            </div>
             <div class="col-sm-12 col-lg-4 col-xs-12 d-flex text-center p-2">
                <div class="col-4 pr-0"> <label for="" class="btn-block h-90 bg-primary border border-dark pt-1 word2 font-weight-bold text-center">Hospital Name</label></div> 
                <div class="col-8"><asp:TextBox ID="TextBox6" runat="server" CssClass="form-control h-90"></asp:TextBox></div>
            </div>
             <div class="col-sm-12 col-lg-4 col-xs-12 d-flex p-2">
                <div class="col-4 pr-0"> <label for="" class="btn-block h-90 bg-primary border border-dark pt-1 word2 font-weight-bold text-center">Phone Number</label></div> 
                <div class="col-8"><asp:TextBox ID="TextBox7" runat="server" CssClass="form-control h-90" TextMode="Phone"></asp:TextBox></div>
            </div>
            </div>
            <div class="row" >
                <div class="col-lg-4 col-sm-12 col-xs-12  d-flex p-2">
                    <div class="col-4 pr-0"> <label for="" class="btn-block bg-primary h-65 border border-dark pt-1 word2 font-weight-bold text-center">Address</label></div> 
                    <div class="col-8"><asp:TextBox ID="TextBox8" runat="server" CssClass="form-control h-100" TextMode="MultiLine"></asp:TextBox></div>
                </div>
            
              <div class="col-sm-12 col-lg-4 col-xs-12 d-flex p-2">
                <div class="col-4 pr-0"> <label for="" class="btn-block bg-primary h-65 border border-dark pt-1 word2 font-weight-bold text-center">Provisional Diagnosis</label></div> 
                <div class="col-8"><asp:TextBox ID="TextBox9" runat="server" CssClass="form-control h-100" TextMode="MultiLine"></asp:TextBox></div>
            </div>
             <div class="col-sm-12 col-lg-4 col-xs-12 d-flex p-2">
                <div class="col-4 pr-0"> <label for="" class="btn-block bg-primary h-65 border border-dark pt-1 t1-size word2 font-weight-bold text-center">Brief History</label></div> 
                <div class="col-8"><asp:TextBox ID="TextBox10" runat="server" CssClass="form-control h-100" TextMode="MultiLine"></asp:TextBox></div>
            </div>
            </div>
            </fieldset>
    </div>
